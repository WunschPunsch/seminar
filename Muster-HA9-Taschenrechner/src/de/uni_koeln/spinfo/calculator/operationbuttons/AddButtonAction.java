...
/**
 * Diese Klasse realisiert die "+"-Taste des Taschenrechners.
 * Sie ist von AbstractButtonAction abgeleitet, so dass lediglich die
 * abstrakte Methode "executeOperation" implementiert und der Konstruktor
 * von AbstractButtonAction aufgerufen werden muss. Dadurch wird der 
 * Aufwand für die Realisierung einer neuen (mathematischen) Funktion 
 * auf ein Minimum reduziert - sehen Sie sich den Sourcecode dieser Klasse
 * an, er besteht aus lediglich 4 Anweisungen!
 * @author sschwieb
 *
 */
public class AddButtonAction extends AbstractButtonAction {
	...
	protected void executeOperation(Integer firstParam, Integer secondParam) {
		...
		System.out.println("executeOperation \"add\" with " + firstParam + " and " + secondParam);
